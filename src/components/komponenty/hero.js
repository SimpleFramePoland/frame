...
export default function Hero(){ 
 return (
   ...
   <div className="relative flex items-center justify-center bg-black bg-no-repeat h-screen  bg-cover  ">
      <h1 className='px-8 z-20 text-6xl lg:text-8xl h-[11rem] flex items-center  align-middle font-bold text-white bg-black bg-opacity-75 rounded-xl text-center'>Stworzymy Twój Film</h1>
