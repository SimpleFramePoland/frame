...
const uslugi = [
  ...
  { name: 'Sesje zdjęciowe', description: 'Uchwyć wspaniałe obrazy, które reprezentują Twoją markę i przyciągają klientów', href: '/fotografia', icon: CameraIcon },
  { name: 'Fotografia techniczna', description: 'Technologia uchwycona w perfekcyjnym kadrze', href: '/fotografia-techniczna', icon: ComputerDesktopIcon },
