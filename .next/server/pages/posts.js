...
/* harmony export */ });
/* harmony import */ var hooks_use_page_metadata__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6314);
/* harmony import */ var lib_categories__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5706);
...
function Posts({
  ...
  const {
    metadata
  } = (0,hooks_use_page_metadata__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)({
    metadata: {
      title,
      description: false
    }
  });
  return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx(templates_archive__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z, {
...
async function getStaticProps() {
  const {
    posts,
    pagination
  } = await (0,lib_posts__WEBPACK_IMPORTED_MODULE_2__/* .getPaginatedPosts */ .BP)({
    queryIncludes: 'archive'
  });
  const {
    categories
  } = await (0,lib_categories__WEBPACK_IMPORTED_MODULE_1__/* .getAllCategories */ .tG)();
  return {
    props: {
      categories,
      posts,
...
var __webpack_exports__ = __webpack_require__.X(0, [270,676,61,489,2,265,166,677,264], () => (__webpack_exec__(9294)));
